...
uint256 hashGenesisBlock("0xa9fbf4734fa71701835a22da40a00b166c25cf3edb6a366227fc1cbbc98c5116");
...
static const int64 nTargetTimespan = 600; // THCoin: 5 minutes
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa9fbf4734fa71701835a22da40a00b166c25cf3edb6a366227fc1cbbc98c5116");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Scarborough residents 'heartbroken' as new skating rink delayed until next winter ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506056607;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3193008;
        ...
        assert(block.hashMerkleRoot == uint256("0x197aecbf55f7e7be3dcf8bac40f3892ee60815652b1af4e0c9daa3f16df23c8d"));
